...
///
/// Pass to [AMap.onMapCreated] to receive a [AMapController] when the
/// map is created.
...
/// A widget which displays a map with data obtained from the AMap service.
class AMap extends StatefulWidget {
  /// Creates a widget displaying data from AMap services.
  ///
  ...
  /// Callback method for when the map is ready to be used.
  ///
  /// Used to receive a [AMapController] for this [AMap].
  ...
  /// retrieved with [AMapController.getStyleError].
  ///
  ...
  /// Called every time a [AMap] is tapped.
  final ArgumentCallback<LatLng>? onTap;

  /// Called every time a [AMap] is long pressed.
...
class _AMapState extends State<AMap> {
  ...
  Widget build(BuildContext context) {
    return AMapFlutterPlatform.instance.buildViewWithConfiguration(
      _mapId,
  ...
  @override
  void didUpdateWidget(AMap oldWidget) {
...
MapConfiguration _configurationFromMapWidget(AMap map) {
